...
public class playerScript : MonoBehaviour {
	...
	void Update () {
		print (fan.position + "" + fan.localPosition);
		
		if (Input.GetKeyDown("space")) {
			//print("space key was pressed"+rigidbody2D.velocity);
//			print (string.Format("{0},{1}", rigidbody2D.velocity.x, rigidbody2D.velocity.y));
